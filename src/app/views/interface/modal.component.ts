...
export class ModalComponent{
    ...
    open1(template: TemplateRef<any>, size : string) {
        this.modalRef = this.modalService.show(template, Object.assign({}, this.config, {class: 'modal-' + size}));
    };

    openModalEvent(template: TemplateRef<any>) {
        this.messages = [];
